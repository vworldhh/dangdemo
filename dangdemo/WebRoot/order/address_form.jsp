...
<html xmlns="http://www.w3.org/1999/xhtml">
	...
	<body>
		...
		<div class="fill_message">
			...
			<form name="ctl00" method="get" action="<%=request.getContextPath()%>/address" id="f">
			...
			<div class="login_in">
				<a href="<%=request.getContextPath()%>/order/order_info.jsp"><input id="btnClientRegister" class="button_1" name="submit"
					type="submit" value="取消" /></a>
			
				<a href="<%=request.getContextPath()%>/order/order_ok.jsp"><input id="btnClientRegister" class="button_1" name="submit"
