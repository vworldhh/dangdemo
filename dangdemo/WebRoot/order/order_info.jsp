...
<html xmlns="http://www.w3.org/1999/xhtml">
	...
	<body>
		...
		<div class="fill_message">
			...
			<table class="tab_login">
				<tr>
                   ...
                   <%
                      int sum = 0;
                      double S = 0.0;
				       List<Book> Shoppingbook = (List<Book>)session.getAttribute("listbook");
			...
			<br />
			<div class="login_in">
				<a href="<%=request.getContextPath()%>/cart/cart_list.jsp"><input id="btnClientRegister" class="button_1" name="submit"
					type="submit" value="取消" /></a>
			
				<a href="<%=request.getContextPath()%>/order/address_form.jsp"><input id="btnClientRegister" class="button_1" name="submit"
